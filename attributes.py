   ...
   # print(keywordslist)
    ...
    for  idx, keyxs in  enumerate(keywordslist):
                ...
                #print("\n")
                    ...
                    #print(keyxs)
                   #print(jdx)
                    keyproperties.append(( frequency, dist_phrase, len_phrase,nnp, nn, jj, vb, cd,sumsimilarity[idx] ,  1))
                    
        #print(len(keyproperties)) 
    file=open("C:/Users/pudutta/Desktop/Demo/attributesofcandidatekeywords.txt", "w")    
    for keyprop in keyproperties:
        #print(keyprop)
        #print("\n")
        for idx, keyp in enumerate(keyprop):
            if(idx==len(keyprop)-1):
                file.write(str(keyp))
            else:
                file.write(str(keyp))
                file.write(",")
